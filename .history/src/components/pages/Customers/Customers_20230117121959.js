...
const Customers = () => {
  ...
  function MyVerticallyCenteredModal(props) {
    ...
    const EditCustomer = async (e) => {
      e.preventDefault()
      try{
        const data = await axios.put( `http://ec2-15-206-210-177.ap-south-1.compute.amazonaws.com:5002/api/updateUserinadmin/${id}`, {
          name , phoneNumber  , gender ,email , birth , city  , website , walletAmount
        })
      }catch(err){
        console.log(err)
      }
          ...
          <Container>
            <Form>
              ...
              <Form.Group>
                ...
                <Form.Control type="date" onChange={(e) => setBirth(e.target.value)} />
              </Form.Group>
              <Form.Group>
              ...
              <Form.Group>
                ...
                <Form.Control type="number"  onChange={(e) => setWallet(e.target.value)}/>
              </Form.Group>
              <br />
              <Button
