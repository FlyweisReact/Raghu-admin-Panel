    ...
    return (
      ...
      >
        ...
        <Modal.Body>
          {edit ? (
            <Container >
                <img src={"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTF4WvC5PYhh90XerR_RZXPr2mpyVzAB_f7jg&usqp=CAU"} alt='' style={{width : '400px' , height : '200px' , display : 'block' , margin : 'auto'}} />
                <p style={{color : 'black'}}><span>Date : </span> 23 feb 2023</p>
            </Container>
          ) : (
            <Form>
