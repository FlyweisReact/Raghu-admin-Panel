...
const Expert = () => {
  ...
  function MyVerticallyCenteredModal(props) {
    ...
    const postData = async (e) => {
      e.preventDefault()
      try{
        const { data } = await axios.post("https://52pv9t2fl3.execute-api.ap-south-1.amazonaws.com/dev/api/v1/experts" , {image : imageUrl , name , position , facebook , twitter , others , })
      }catch(e){
        console.log(e)
      }
    }
