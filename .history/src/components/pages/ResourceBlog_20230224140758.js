      ...
      <div className="blogs">
        {data.map((i, index) => (
          <div key={index}>
            ...
            <Button style={{width : '80%' , display : 'block' , margin : 'auto' , marginTop : '5px'}}>View</Button>
            <Button style={{width : '80%' , display : 'block' , margin : 'auto' , marginTop : '5px'}} variant='outine-danger'>Delete</Button>
          </div>
        ))}
      </div>
    </>
