        ...
        <div style={{ display: "flex", gap: "20px" }}>
          ...
          >
            ...
            <p   style={{
              ...
              padding: "10px",
              marginTop: "20px",
            }}>  <span style={{ fontWeight: "600" }}>About :</span>F  ${data.price}</p>
        <p   style={{
              fontSize: "20px",
              border: "1px solid black",
              width: "500px",
              padding: "10px",
              marginTop: "20px",
            }}>   <span style={{ fontWeight: "600" }}>About :</span>${data.actualprice}</p>
        <p   style={{
              fontSize: "20px",
              border: "1px solid black",
              width: "500px",
              padding: "10px",
              marginTop: "20px",
            }}>  <span style={{ fontWeight: "600" }}>About :</span> {data.discount}%</p>
            </div>
