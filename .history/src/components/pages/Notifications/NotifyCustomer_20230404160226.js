...
const NotifyCustomer = () => {
  ...
  function ViewSection(props) {
    ...
    const deleteHandler = async (id) => {
      try{
        const { data } = await axios.delete(`https://52pv9t2fl3.execute-api.ap-south-1.amazonaws.com/dev/api/v1/course/delete/642bfa19b4627114ee34ab3f`)
      }catch(e){
        console.log(e)
      }
    }
  ...
  return (
    <>
      ...
      <AddSection show={add} onHide={() => setAdd(false)} />
