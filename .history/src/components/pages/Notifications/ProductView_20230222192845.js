    ...
    <>
      <div style={{ color: "black" }}>
       ...
       <p style={{fontSize :'2rem' , border : '1px solid black' , width : '400px' , padding : '10px' , marginTop : '20px'}}> <span style={{fontWeight : '600'}}>Title:</span> {data.title}</p>
        ...
        <p style={{fontSize :'20px' , border : '1px solid black' , width : '500px' , padding : '10px' , marginTop : '20px'}}><span style={{fontWeight : '600'}}>Content:</span>{data.content}</p>
        <p style={{fontSize :'20px' , border : '1px solid black' , width : '500px' , padding : '10px' , marginTop : '20px'}}>{data.about}</p>
        <p> {data.price}</p>
